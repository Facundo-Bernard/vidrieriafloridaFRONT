...
const validators = {
  ...
  sitio: (v) => v.trim().length === 0, // honeypot
};
...
export default function ContactoForm() {
  ...
  const isValid = useMemo(() => {
    return ["nombre", "telefono", "email", "mensaje"].every((k) =>
  ...
  return (
    <div>
      <NAVBAR />
      <div
        style={{ backgroundColor: "#f8f9fa", minHeight: "100vh", paddingTop: 48, marginTop: 90 }}
      >
        <style>{styles}</style>
            ...
            >
              <div className="card shadow-soft rounded-4 border-0">
                <div className="card-body p-4 p-md-4">
                  <div ref={statusRef} aria-live="polite" aria-atomic="true" className="mb-2">
                    {status === "success" && (
                    ...
                    <div className="row g-3">
                      <div className="col-md-6">
                        ...
                        {touched.nombre && errors.nombre && (
                          <div className="invalid-feedback">Ingresá al menos 3 caracteres.</div>
                        )}
                      </div>
                      ...
                      <div className="col-md-6">
                        ...
                        {touched.telefono && errors.telefono && (
                          <div className="invalid-feedback">Ingresá un teléfono válido.</div>
                        )}
                      </div>
                      ...
                      <div className="col-12">
                        ...
                        <textarea
                          ...
                          rows={6}
                          className={`form-control rounded-3 ${
                            touched.mensaje && errors.mensaje ? "is-invalid" : ""
                          }`}
                        ...
                        {touched.mensaje && errors.mensaje && (
                          <div className="invalid-feedback">Escribí entre 10 y 1200 caracteres.</div>
                        )}
                      </div>
                      ...
                      <div className="col-12 text-center mt-2">
                        ...
                        <p className="mt-2 text-muted small">
                          {enviosRestantes > 0
                            ? `Podés enviar ${enviosRestantes} mensaje${
                                enviosRestantes === 1 ? "" : "s"
                              } más.`
